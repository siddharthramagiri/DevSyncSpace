...
const Index = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="border-b bg-white">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/login">
              <Button variant="default" className="hidden md:inline-flex">Log in</Button>
            </Link>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-white to-gray-200 py-16 md:py-24">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-gray-600">
            ...
            {/* Feature Card 2 */}
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-green-600">
            ...
            {/* Feature Card 3 */}
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-blue-600">
            ...
            {/* Feature Card 4 */}
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-purple-600">
            ...
            {/* Feature Card 5 */}
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-orange-600">
            ...
            {/* Feature Card 6 */}
            <div className="rounded-lg border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-red-600">
      ...
      {/* CTA Section */}
      <section className="bg-gray-500 py-16 text-white md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/login">
            <Button size="lg" className="bg-white text-gray-500 hover:bg-gray-100">
              Start your free trial
            </Button>
          </Link>
        </div>
      </section>
      <div className=" border-t-1 py-8 text-center text-sm bg-gray-500 text-white">
